...
```bash
vitra new myapp
# or: vitra new myapp --template vite|react|svelte|vue|solid|preact|lit|alpine|htmx|angular|qwik|mithril|riot|inferno|stencil|marko|ember|aurelia|stimulus|petite-vue|hyperapp|knockout|backbone|nerv|polymer|dojo|elm|rescript|squint|cherry|vanjs|reef|atomico|sinuous|haunted|arrow|hybrids
cd myapp
...
vitra doctor
vitra new ./myapp
# vitra new ./myapp --template vite|react|svelte|vue|solid|preact|lit|alpine|htmx|angular|qwik|mithril|riot|inferno|stencil|marko|ember|aurelia|stimulus|petite-vue|hyperapp|knockout|backbone|nerv|polymer|dojo|elm|rescript|squint|cherry|vanjs|reef|atomico|sinuous|haunted|arrow|hybrids
vitra dev
vitra build
