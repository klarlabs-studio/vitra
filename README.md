...
```bash
vitra new myapp
# or: vitra new myapp --template vite|react|svelte|vue|solid|preact|lit|alpine|htmx|angular|qwik|mithril|riot
cd myapp
...
vitra doctor
vitra new ./myapp
# vitra new ./myapp --template vite|react|svelte|vue|solid|preact|lit|alpine|htmx|angular|qwik|mithril|riot
vitra dev
vitra build
