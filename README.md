...
| Distribution (Phase 4) | Specs + Linux stage / `.deb` / AppDir + signed update apply |
| Isolation / enterprise (Phase 5) | Contracts + Runtime policy/audit/workers (in-process; no OS spawn) |
