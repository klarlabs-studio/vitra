...
| `platform/windows` DesktopHost | Win32 shell + chrome + dialogs + menu/tray + drag-drop + OpenURL/clipboard/single-instance/deep-link/scheme/files; WebView2 Eval TBD |
