...
| Capability-gated desktop services | `desktop` — menu (+ in-window accelerators), tray, dialog, clipboard, shortcuts, single-instance, deeplinks, drag-drop, window chrome |
